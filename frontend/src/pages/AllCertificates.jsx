...
import { Award, ExternalLink, Calendar, Building2, ArrowLeft } from 'lucide-react';
      ...
      <section className="py-20 bg-black min-h-screen">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-light text-white mb-4 tracking-tight" style={{ fontFamily: 'Times New Roman, serif' }}>
              All Certifications
            </h1>
            <p className="text-gray-400 text-base font-light max-w-3xl mx-auto leading-relaxed">
              Complete collection of my professional certifications and courses across AI, data analytics, programming, and design
            </p>
          </motion.div>
