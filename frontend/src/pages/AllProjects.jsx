...
import { ExternalLink, Github, Bot, Search, CheckCircle, Coffee, Flame, Users, Palette, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="py-20 bg-black min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-light mb-4 text-white tracking-tight" style={{ fontFamily: 'Times New Roman, serif' }}>
              All Projects
            </h1>
            <p className="text-gray-400 text-base font-light max-w-2xl mx-auto leading-relaxed">
              Complete collection of my work across AI engineering, web development, and UI/UX design
            </p>
          </motion.div>
                      ...
                      <div className="mb-6">
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.map((tech) => (
                            <span
                              key={tech}
                              className="px-2 py-1 text-xs font-medium bg-white/5 text-gray-300 rounded-md border border-white/10"
                            >
                              {tech}
                            </span>
                          ))}
                      ...
                      <div className="flex gap-4">
                        {project.github && (
                          <a
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-white/5 text-white rounded-lg hover:bg-white/10 transition-colors duration-200 text-sm"
                          >
                        ...
                        {project.demo && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-4 py-2 bg-white text-black rounded-lg hover:bg-gray-200 transition-colors duration-200 text-sm font-medium"
                          >
                            <ExternalLink className="w-4 h-4" />
                            {project.isNotion ? 'View Portfolio' : 'Demo'}
                          </a>
                        )}
                      </div>
                    </div>
